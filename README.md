...
- 인쇄용 표지: 좌우 80mm 책날개, 본문 258쪽·미색모조 100g 기준 15.5mm 책등, 사방 3mm 도련과 접지 여유를 반영한 483.5 × 216mm 펼침표지
...
- 현재 15.5mm는 교보 가격책정 화면이 258쪽·미색모조 100g 선택에 대해 제시한 예상 책등 두께입니다. 교보의 등록 사양을 바꾸면 `python book/cover/build_cover_pdfs.py --spine-mm 값`으로 다시 조립하고 표지 SVG의 책등 폭도 같은 값으로 조정합니다.
