...
영어 EPUB ISBN과 일본어 EPUB ISBN은 동일한 EPUB 상품을 Google Play와 교보문고에 유통할 때 함께 사용한다. 교보에는 EPUB 두 종만 등록하며, PDF ISBN 두 개는 Google Play에서 PDF를 별도 공개 형식으로 제공하는 계획에만 해당한다.
